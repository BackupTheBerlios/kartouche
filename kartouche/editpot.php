...
echo "
        <table>
				<tr>
					<td colspan=\"4\" align=\"right\">$alt_int <a href=\"editpot_alternative.php?lg=$lg&db_table=$db_table&view=$view&total=$total\">$click_here</a>.</td>
			    </tr>
				<tr>
                ...
                <tr>
                        ...
                        <td width=\"30%\">";
                                ...
                                {
                                echo "
                                <form action=\"editpot.php?lg=$lg&view=$view&db_table=$db_table&total=$total&pointer=$next&submitter=$submitter\" method=\"POST\">
...
echo "
        <form action=\"make_sugg.php?lg=$lg&db_table=$db_table\" method=\"POST\">
        <table>
        <tr>
                <td width=\"5%\">&nbsp;</td>
                <td width=\"30%\" id=\"crumbs\"><h3>$orig_text</h3></td>
                <td width=\"30%\" id=\"crumbs\"><h3>$curr_trans</h3></td>
                <td width=\"30%\" id=\"crumbs\"><h3>$sugg_trans</h3></td>
        </tr>
        <tr>
                <td colspan=\"4\">&nbsp;</td>
        </tr>
        ...
        $bgcolor=(++$n&1) ? "#ffbbff" : "#ffccff";
                ...
                echo "
                        <tr bgcolor=$bgcolor>
                                ...
                                <td width=\"30%\">".htmlspecialchars($row->msgid)."</td>
                                <td width=\"30%\">".htmlspecialchars($row->msgstr)."</td>
                                <td width=\"30%\">
                        ";
                        ...
                        if ($row->suggestion=="")
                                {
                                echo "
                                        <textarea cols=\"30\" rows=\"4\" wrap=\"soft\" name=\"add_me[{$row->id}][suggestion]\"></textarea>
                                        <input type=\"hidden\" name=\"add_me[{$row->id}][id]\" value=\"$row->id\">
                                        </td>
                                        <td width=\"5%\"><input type=\"checkbox\" name=\"list_me[]\" value=\"$row->id\"></td>
                                       ";
                                }
                                else
                                {
                                echo htmlspecialchars($row->suggestion)."</td><td>&nbsp;</td>";
                                }
